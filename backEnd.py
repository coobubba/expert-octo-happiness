...
Done by Dakota Wolfe around 60% of all necessary tests are finished. 

Can't actually be run on it's own must be run via Oppia, if it gets accepted  
"""


#importing the various necessary libraries.
import argparse
import datetime
import os
import re
